...
# 1. Device Setup (Auto-switches to CUDA GPU)
...
DATA_DIR = os.path.join("data", "potato")
MODEL_SAVE_PATH = os.path.join("models", "potato_mobilenet_v3.pth")
BATCH_SIZE = 32
EPOCHS = 12
LR = 1e-3
...
# 4. Ingestion & 80/20 Train-Val Split
...
# Apply separate transforms to splits
...
plot_file = os.path.join("notebooks", "potato_pytorch_metrics.png")
plt.savefig(plot_file)
print(f"Saved metric plots to {plot_file}")