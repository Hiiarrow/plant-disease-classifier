...
% --- FIGURE 1: Real-World Field Adaptation Pipeline Photo ---
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/field_adaptation_pipeline.png}
...
\label{fig:field_adaptation_pipeline}
\end{figure*}
...
% --- FIGURE 2: CBAM Architecture Diagram Photo ---
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/cbam_architecture_diagram.png}
\caption{Architectural flow of Attention-MobileNetV3 incorporating Convolutional Block Attention Modules (CBAM Channel and Spatial Attention) prior to global pooling and the 2-stage linear classifier head.}
...
% --- FIGURE 3: Grad-CAM Visual Attribution Sample Photo ---
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{notebooks/attention_mobilenet_gradcam_sample.png}
\caption{Grad-CAM visual attribution heatmap overlay demonstrating localized lesion spotlighting on necrotic foliar disease spots.}
