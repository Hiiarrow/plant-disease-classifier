...
% --- FIGURE 1: Dataset Samples Grid ---
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{paper_figures/dataset_samples.png}
\caption{Sample photographs from the Kashmiri Apple Orchard real-world field dataset illustrating unconstrained farm background clutter, natural lighting, and shadows.}
...
% --- FIGURE 2: System Pipeline Flow Diagram ---
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{paper_figures/pipeline_flow.png}
\caption{Overview of the 3-stage real-world field adaptation pipeline: input farm photo, HSV/Lab foliar leaf ROI isolation, $8\times$ multi-scale patch super-sampling ($N=2,680$), and Attention-MobileNetV3 feature extraction with 5-crop TTA.}
