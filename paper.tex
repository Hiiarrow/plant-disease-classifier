...
Plant diseases inflict over \$220 billion in annual agricultural losses worldwide. While automated diagnosis using deep learning offers a viable alternative to scarce expert pathology, existing systems face critical barriers to field deployment: edge hardware constraints, black-box predictions, and severe performance drops outside controlled environments.
